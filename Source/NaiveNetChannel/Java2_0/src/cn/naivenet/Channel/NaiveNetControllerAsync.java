...
/**
 * 	异步回应的Controller
 * 	在onRequest中需要手动使用 msg 句柄给出回应，return 无法自动给出消息回应，请注意回应的时间，若时间过长才回应客户端将会发生超时而遗弃该请求的回应。
 * */
public abstract class NaiveNetControllerAsync{
	 ...
	 * */
	public NaiveNetControllerAsync(String name) {
		this.name = name;
	}
	 ...
	 * */
	public abstract void onRequest(NaiveNetMessage msg);
}
